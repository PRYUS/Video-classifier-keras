...
def main():
    ...
    history = classifier.fit(data_dir_path=input_dir_path, model_dir_path=output_dir_path, vgg16_include_top=False, callbacks=callbacks_list, data_set_name=data_set_name, test_size=0.1)
